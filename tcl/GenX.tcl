...
namespace eval GenX { } {
   ...
   set Param(Veges)     { USGS GLC2000 GLOBCOVER CCRS EOSD LCC2000V CORINE MCD12Q1 AAFC CCI_LC CCILC2015-ECO2017 CCILC2015-1 CCILC2015-3 CCILC2015-4 CCILC2015 CCILC2010 USGS_R NALCMS }
   set Param(Soils)     { USDA AGRC FAO HWSD JPL BNU CANSIS SLC SOILGRIDS }
   set Param(SoilDBRKs) { GSRS }
   set Param(Masks)     { USNAVY USGS GLC2000 GLOBCOVER CANVEC MCD12Q1 CCI_LC CCILC2015-ECO2017 CCILC2015-1 CCILC2015-3 CCILC2015-4 CCILC2015 CCILC2010 USGS_R AAFC NALCMS OSM }
   ...
   set Path(CCILC2015-4)  ESA_CCI_LC/2015-4
